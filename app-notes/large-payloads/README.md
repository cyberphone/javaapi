...
Prerequisite: a CBOR decoder being able to read a CBOR object from an _input stream_, while leaving the remaing part of the stream _untouched_.  Using the Java implementation of [CBOR::Core](https://www.ietf.org/archive/id/draft-rundgren-cbor-core-25.html), this works out of the box.
